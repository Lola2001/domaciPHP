...
if (isset($_POST['add'])) {
    ...
    if (empty($_POST['type'])) {
        $errors['type'] = 'Type of cafe is required!';
    } else {
        $type = $_POST['type'];
    }
...
<section class="container">
    <h4 class="center">Submit cafe</h4>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="white form" method="POST">
        ...
        <label for="type">Type of cafe:</label>
        ...
        <div class="center">
            <input type="submit" name="add" value="Submit cafe" class="btn lime darken-2 z-depth-0">
        </div>
    </form>
